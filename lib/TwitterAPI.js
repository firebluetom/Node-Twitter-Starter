...
Twitter.prototype.getSubscriptions = function (params, error, success){
    var path = '/lists/subscriptions.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};

Twitter.prototype.getSubscribers = function (params, error, success){
    var path = '/lists/subscribers.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};

Twitter.prototype.inList = function (params, error, success){
    var path = '/api/is/user/'+params.userId+'/in/list/'+params.listId+'/';
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};
